...
|---|---|---|---:|---:|---:|---:|---|---|---|
| diagrams/capital-architecture.mmd | ΣCapital system architecture overview | ΣCapital | 4314 | 4314 | 28 | 44 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | init directive; derived views listed; FR-20260830 prompt-led provenance discovery, authoritative-source allowlist, and expert attribution boundary |
| diagrams/capital-db-schema.mmd | ΣCapital database entity relationships overview | ΣCapital | 5058 | 5058 | 8 | 0 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | init directive; derived views listed; FR-20260901 OCO recalibration proposal schema |
...
| diagrams/manifest-architecture.mmd | 👁AI-Manifest system architecture overview | 👁AI-Manifest | 3424 | 3410 | 27 | 31 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; derived views listed; FR-20260830 coordinator MCP contract |
| diagrams/manifest-db-schema.mmd | 👁AI-Manifest database entity relationships | 👁AI-Manifest | 4639 | 4621 | 11 | 0 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | init directive; Unicode labels; FR-20260830 batch replay, request_payload, and updated_at contract; AI-Manifest 22ecc58 |
| diagrams/manifest-tech-stack.mmd | 👁AI-Manifest technology stack | 👁AI-Manifest | 4076 | 4058 | 30 | 35 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; FR-20260830 xdist reconciliation; coordinator MCP contract |
...
| diagrams/quantum-architecture.mmd | ⟨ψ⟩Quantum system architecture overview | ⟨ψ⟩Quantum | 2253 | 2250 | 26 | 14 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; derived view: diagrams/quantum-derived-cache-integrity.mmd; split_required=false; FR-20260831 benchmark provenance contract |
...
| diagrams/quantum-tech-stack.mmd | ⟨ψ⟩Quantum technology stack | ⟨ψ⟩Quantum | 2174 | 2164 | 28 | 15 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; FR-20260830 xdist reconciliation; FR-20260831 benchmark provenance contract |
...
| diagrams/workspace-architecture-detail.mmd | ⊕Workspace decision-metadata and agent-handoff ownership detail | ⊕Workspace | 3909 | 3902 | 37 | 25 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; derived companion listed; measured under detail budget |
| diagrams/workspace-architecture.mmd | ⊕Workspace high-level architecture | ⊕Workspace | 4519 | 4490 | 40 | 27 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; handoff envelope/result and takeover boundary; federated repository-local manifest to generated aggregate registry boundary |
...
| diagrams/workspace-integrations.mmd | ⊕Workspace external integration topology overview | ⊕Workspace | 3249 | 3224 | 27 | 27 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; derived views listed; federated repository-local manifest to generated aggregate registry boundary |
...
| diagrams/manifest-derived-media-pipeline.mmd | 👁AI-Manifest media pipeline derived view | 👁AI-Manifest | 2568 | 2566 | 33 | 37 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; parent traceability |
| diagrams/manifest-derived-todo-and-backup.mmd | 👁AI-Manifest TODO and backup derived view | 👁AI-Manifest | 2587 | 2579 | 19 | 23 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; parent traceability; FR-20260830 coordinator MCP contract |
| diagrams/workspace-derived-backup-and-coordination.mmd | ⊕Workspace backup and coordination derived view | ⊕Workspace | 2103 | 2098 | 20 | 23 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; parent traceability |
