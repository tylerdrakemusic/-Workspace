...
| diagrams/workspace-architecture.mmd | ⊕Workspace high-level architecture | ⊕Workspace | 3951 | 3929 | 36 | 24 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Unicode labels; init directive; handoff envelope/result and takeover boundary |
...
| diagrams/workspace-scheduler-architecture.mmd | Evidence-linked external scheduler architecture view across six projects | Cross-project | 2991 | 2946 | 34 | 12 | Rendered: mermaid.ink HTTP 200 | HTTP 200 | Workspace-owned source; records and evidence: docs/scheduler-architecture-inventory.md; no live scheduler, monitoring, DB schedule fields, or schedule editing |
