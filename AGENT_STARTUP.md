...
- `.github/ownership.md` — Canonical ownership map for central and repository-local Markdown
...
Project-specific agents, instructions, and prompts live in the owning repository's
`.github/` directory. Central `.github/` retains shared interfaces, general
skills, shared prompts, root instructions, security policy, and legacy FR records.
