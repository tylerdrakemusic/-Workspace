...
Self-contained: reads ELEVENLABS_API_KEY from environment.
No dependency on any per-project config or token-file utilities.
...
# Settings constants — also exported via settings.py for direct consumer imports.
