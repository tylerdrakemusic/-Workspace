"""Canonical shared Ollama HTTP client for localhost inference.

This module is the single source of truth for Ollama access across all
...
_READ_TIMEOUT = 120.0  # generation can take a while for large prompts
