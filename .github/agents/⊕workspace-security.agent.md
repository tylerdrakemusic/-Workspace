...
**Manifest:** `f:\⊕Workspace\.github\!!☾⛧security\agent-manifest.json`
**QEC engine:** `f:\⊕Workspace\.github\!!☾⛧security\quantum_entropy_cipher.py`
...
2. Hash every file in `f:\⊕Workspace\.github\agents\`, `f:\⊕Workspace\.github\instructions\`, `f:\⊕Workspace\.github\skills\`
...
Regenerate manifest: `C:\G\python.exe f:\⊕Workspace\.github\!!☾⛧security\update_manifest.py`
...
`C:\G\python.exe f:\⊕Workspace\.github\!!☾⛧security\quantum_entropy_cipher.py --status`
