...
6. "Save & Regenerate" modal UX is behavior-identical to Lily's modal on the executive portal (single `POST /update-nova-prompt` endpoint, spinner state, in-place portrait refresh, no page reload).
