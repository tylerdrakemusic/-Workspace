...
| --- | ---------------------------------------------------- | ---------------------- | ----------- | ----- | ---------- |
| AC1 | Desktop shortcut calls open_portal.ps1               | ⊕workspace-overseer    | not-started | —     | 2026-05-09 |
| AC2 | Remove stale studio entry from ⊕Workspace dashboard.json; rename ❤Music entry to "❤ Studio" | ⊕workspace-overseer | not-started | — | 2026-05-09 |
| AC3 | ∞Life dashboard.json: type=flask_app, url=:8300      | ⊕workspace-overseer    | not-started | —     | 2026-05-09 |
| AC4 | open_portal.ps1: auto-regen FR + Agent Ops on launch | ⊕workspace-overseer    | not-started | —     | 2026-05-09 |
| AC5 | Fix CORS URL in agent_ops_monitor.py                 | ⊕workspace-overseer    | not-started | —     | 2026-05-09 |
| AC6 | Fix Mermaid NaN in diagrams_dashboard.py             | ⊕workspace-overseer    | not-started | —     | 2026-05-09 |
