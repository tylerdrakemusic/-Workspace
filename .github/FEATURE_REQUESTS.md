...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260510-workspace-discovery-agent | Workspace Discovery Agent — epic/story-level todo opportunity scanner | feature | ⊕Workspace, 👁AI-Manifest | TRIAGED | pending | pending | ⊕workspace-intake | 2026-05-10 | 2026-05-10 |
