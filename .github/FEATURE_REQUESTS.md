...
| FR-20260516-suno-stem-isolation | Suno stem isolation CLI via Demucs htdemucs_6s | feature | ❤Music | REVIEW_REQUESTED | feature/music/fr-20260516-suno-stem-isolation | pending | ❤music-orchestrator | 2026-05-16 | 2026-05-16 |
| FR-20260516-dead-open-in-browser | Remove dead "Open in Browser ↗" button from Live Dashboard header | bugfix | ⊕Workspace | MERGED | fix/workspace/fr-20260516-dead-open-in-browser | https://github.com/tylerdrakemusic/-Workspace/pull/154 | ⊕workspace-intake | 2026-05-16 | 2026-05-16 |
...
| FR-20260515-chat-customizations-eval-ext | Evaluate & onboard `ms-vscode.vscode-chat-customizations-evaluations` for workspace agent QA | chore + research | ⊕Workspace | BRANCHED | chore/workspace/fr-20260515-chat-customizations-eval-ext | [-Workspace#153](https://github.com/tylerdrakemusic/-Workspace/pull/153) (draft) | ⊕workspace-ci | 2026-05-15 | 2026-05-15 |
| FR-20260514-security-vuln-remediation | Security Vulnerability Dashboard — Scanner Exclusion Fix + Full Remediation Sprint (1505 → 0 open) | security-fix + chore | All 5 projects | BRANCHED | fix/workspace/fr-20260514-security-vuln-remediation<br>fix/life/fr-20260514-security-vuln-remediation<br>fix/music/fr-20260514-security-vuln-remediation<br>fix/quantum/fr-20260514-security-vuln-remediation<br>fix/ai-manifest/fr-20260514-security-vuln-remediation | [-Workspace#151](https://github.com/tylerdrakemusic/-Workspace/pull/151) + [Life#29](https://github.com/tylerdrakemusic/Life/pull/29) + [Music#49](https://github.com/tylerdrakemusic/Music/pull/49) + [Quantum#21](https://github.com/tylerdrakemusic/Quantum/pull/21) + [AI-Manifest#31](https://github.com/tylerdrakemusic/AI-Manifest/pull/31) | ⊕workspace-ci | 2026-05-14 | 2026-05-14 |
...
| FR-20260512-radio-duplicate-tracks-bugfix | Radio station playing duplicate tracks � implement no-repeat shuffle + quantum variance analysis | fix + feature | ?Music, ???Quantum | TRIAGE_COMPLETE | pending | pending | ?workspace-ci | 2026-05-12 | 2026-05-12 |
| FR-20260512-executive-panel-localhost-refused | Executive Panel localhost refused bugfix | fix | ?Workspace, ??AI-Manifest | MERGED | fix/workspace/fr-20260512-executive-panel-localhost-refused � fix/ai-manifest/fr-20260512-executive-panel-localhost-refused | [-Workspace#136](https://github.com/tylerdrakemusic/-Workspace/pull/136) (merge 0317feb) + [AI-Manifest#28](https://github.com/tylerdrakemusic/AI-Manifest/pull/28) (merge 4a1ada7) | ?workspace-ci | 2026-05-12 | 2026-05-13 |
| FR-20260512-quantum-vqe-execution-policy-card | Quantum Benchmark Dashboard - add VQE execution policy card | feature | ???Quantum | MERGED | feature/quantum/fr-20260512-quantum-vqe-execution-policy-card | [Quantum#17](https://github.com/tylerdrakemusic/Quantum/pull/17) (merged 7b12e07) | tyler-signed-off-pending | 2026-05-12 | 2026-05-13 |
| FR-20260512-ollama-todos-reprioritize | Bulk reprioritize all open todos using Ollama Llama model (one-time) | enhancement | ??AI-Manifest, ?Workspace | CLOSED | N/A | N/A | ?workspace-overseer | 2026-05-12 | 2026-05-12 |
| FR-20260510-workspace-discovery-agent | Workspace Discovery Agent � epic/story-level todo opportunity scanner | feature | ?Workspace, ??AI-Manifest | MERGED | feature/workspace/fr-20260510-workspace-discovery-agent<br>feature/ai-manifest/fr-20260510-workspace-discovery-agent | [-Workspace#129](https://github.com/tylerdrakemusic/-Workspace/pull/129) (merge f52b3435) + [AI-Manifest#24](https://github.com/tylerdrakemusic/AI-Manifest/pull/24) (merge 474cb094) | ?workspace-ci | 2026-05-10 | 2026-05-10 |
| FR-20260510-quantum-exec-policy-observability | Quantum Execution Policy Observability and Benchmark Schedule Visibility | feature | ???Quantum, ?Workspace | BRANCHED | feature/quantum/fr-20260510-quantum-exec-policy-observability<br>feature/workspace/fr-20260510-quantum-exec-policy-observability | [Quantum draft-create](https://github.com/tylerdrakemusic/Quantum/pull/new/feature/quantum/fr-20260510-quantum-exec-policy-observability) + [-Workspace draft-create](https://github.com/tylerdrakemusic/-Workspace/pull/new/feature/workspace/fr-20260510-quantum-exec-policy-observability) (auth blocked; PR numbers pending) | ?workspace-ci | 2026-05-10 | 2026-05-10 |
| FR-20260510-disable-executive-audio-autolaunch | Disable Executive Audio Brief auto-launch on desktop startup; keep main portal access | fix | ?Workspace | TRIAGED | pending | pending | ?workspace-intake | 2026-05-10 | 2026-05-10 |
...
| FR-20260510-trudiagnostic-ingest | TruDiagnostic TruAge Ingest � April 2026 (OMICm Age, SYMPHONYAge, DunedinPACE, Telomere) + Reusable Importer | feature + data-ingest | 8Life | BRANCHED | feature/life/fr-20260510-trudiagnostic-ingest | [Life#21](https://github.com/tylerdrakemusic/Life/pull/21) (draft) | 8life-orchestrator | 2026-05-10 | 2026-05-10 |
...
| FR-20260509-portal-hygiene-sprint | ?Workspace Portal Hygiene Sprint � desktop launcher, studio dedup, biomarker live server, Agent Ops sync, console errors | fix + chore | ?Workspace, ?Music, 8Life | MERGED | fix/workspace/fr-20260509-portal-hygiene-sprint | #113, #20, #35 | ?workspace-overseer | 2026-05-09 | 2026-05-09 |
| FR-20260506-master-sync-logging | Add execution-layer logging to nightly master sync | chore | 8Life | BRANCHED | chore/life/fr-20260506-master-sync-logging | pending | ?workspace-overseer | 2026-05-06 | 2026-05-06 |
| FR-20260506-trainerize-workout-sync | Trainerize Workout Sync for 8Life (Auth + Workout Import) | feature | 8Life | REVIEW_REQUESTED | feature/life/fr-20260506-trainerize-workout-sync | [Life#14](https://github.com/tylerdrakemusic/Life/pull/14) | ?workspace-overseer | 2026-05-06 | 2026-05-06 |
| FR-20260505-mfp-nutrition-sync-fix | Fix MFP Nutrition Trend Live Sync (Auth Repair + Daily Auto-Refresh) | fix | 8Life | TRIAGED | pending | pending | ?workspace-intake | 2026-05-05 | 2026-05-05 |
...
| FR-20260428-shors-monthly-qpu-bench | Shor's Monthly QPU Benchmark + Live Dashboard Redesign | feature | ???Quantum | REVIEW_REQUESTED | feature/quantum/shors-monthly-bench | PR #9 open | ?workspace-overseer | 2026-04-28 | 2026-04-28 |
| FR-20260428-quantum-cache-rebuild | ty_string_cache Cleanup + Band-Aware IBM Quantum Cache Filler | fix+feature | ???Quantum | DONE | feature/quantum/cache-rebuild | PR #7, #8 merged | ?workspace-overseer | 2026-04-28 | 2026-04-28 |
...
| FR-20260503-nova-biomarker-portrait | 8Life Nova Biomarker Portrait System � AI persona portrait panel mirroring Lily architecture | feature | 8Life | MERGED | feature/life/nova-biomarker-portrait | [Life#9](https://github.com/tylerdrakemusic/Life/pull/9) (merged) | ?workspace-ci | 2026-05-03 | 2026-05-03 |
...
| FR-20260501-weight-trend-sync-fix | Restore Weight Trend live sync (Withings + Garmin) | fix | 8Life | MERGED | [Life#8](https://github.com/tylerdrakemusic/Life/pull/8) (squash 3029166f) | 2026-05-01 | 2026-05-01 |
| FR-20260430-quantum-skip-slow-tests | Skip @slow tests by default in Quantum CI (pytest.ini) | chore | ???Quantum | MERGED ? CLOSED | Quantum#13 (squash 69475a6) | 2026-04-30 | 2026-04-30 |
| FR-20260430-quantum-dashboard-gitignore | gitignore generated benchmark_dashboard.html (regen-only) | chore | ???Quantum | MERGED ? CLOSED | Quantum#14 (squash ac2b74f) | 2026-04-30 | 2026-04-30 |
| FR-20260430-vqe-aer-bench | VQE for H2 + LiH (Aer baseline + dashboard panel) | feature | ???Quantum | MERGED ? CLOSED | Quantum#12 (merge 9b8df2e) | 2026-04-30 | 2026-04-30 |
...
| FR-20260428-gig-inventory-checklist | Gig Inventory Checklist Tab in Band Management Panel | feature | ?Music | MERGED ? CLOSED | Music#20 (merged by Tyler 2026-04-28) | 2026-04-28 | 2026-04-28 |
| FR-20260427-quantum-rt-fallback-docs | quantum_rt: document secrets fallback paths explicitly | chore | ???Quantum | MERGED ? CLOSED | Quantum#5 (Tyler signed off 2026-04-28) | 2026-04-27 | 2026-04-28 |
...
| FR-20260426-biomarker-external-portal | External Portal Integration for Biomarker Health Panel | feature | 8Life | MERGED ? CLOSED | Life#4 (merge 25e39a2) | 2026-04-26 | 2026-04-26 |
...
| FR-20260426-reconcile-gaps-ledgers-todos | Reconcile Gaps: Agent Ops Monitor, FR Ledgers, and All-Project TODOs | chore | ?Workspace, ?Music, 8Life, ???Quantum, ??AI-Manifest | MERGED ? CLOSED | N/A � markdown-only, Tyler signed off 2026-04-26 | 2026-04-26 | 2026-04-26 |
...
| FR-20260425-ci-test-harness-gateway | CI Test Harness Gateway + Branch Protection (All 5 Repos) | feature | All 5 | MERGED ? CLOSED | -Workspace#24 (d780d9a8), Life#3 (ce448ea), Music#4, Quantum#2, AI-Manifest#6 � 4 public branch-protected, 8Life pre-push hook + doc, AC7 smoke verified merge-block (PR#25 405) | 2026-04-25 | 2026-04-25 |
| FR-20260424-infinitelife-db-restore | 8Life � Restore DB, data sync pipeline, and live Biomarker Dashboard | feature | 8Life, ?Workspace | CLOSED | Life#2 | 2026-04-24 | 2026-04-25 |
...
| FR-20260422-gitignore-sweep | Add .gitignore to all remaining projects | chore | 8Life, ???Quantum, ??AI-Manifest, ?Workspace | CLOSED | e3586e6 / af188c9 / f90f64c / bab2dad | 2026-04-22 | 2026-04-22 |
