...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260503-mic-config-template | 1-page printable mic configuration tracking template (Hyperthreat Studios) | feature | ❤Music, ⊕Workspace | BRANCHED | feature/❤music/mic-config-template, feature/⊕workspace/studio-portal-panel | [Music#26](https://github.com/tylerdrakemusic/Music/pull/26), [-Workspace#86](https://github.com/tylerdrakemusic/-Workspace/pull/86) | ⊕workspace-overseer | 2026-05-03 | 2026-05-03 |
