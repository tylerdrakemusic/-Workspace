...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260502-import-originals-lyrics | Import Originals Lyrics from `❤Music/lyrics/` into Catalog (+ relocate People*.pdf to covers/) | feature | ❤Music | BRANCHED (pending CI) | feature/❤music/import-originals-lyrics | pending | ⊕workspace-ci | 2026-05-02 | 2026-05-02 |
