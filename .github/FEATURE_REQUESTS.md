...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260510-self-hosted-radio-poc | Self-hosted radio POC — Icecast 2 + Liquidsoap on WSL2, streaming Tyler catalog (Phase alpha per IP_STRATEGY.md Section 7) | feature | ❤Music | BRANCHED | feature/music/fr-20260510-self-hosted-radio-poc | pending | ⊕workspace-ci | 2026-05-10 | 2026-05-10 |
