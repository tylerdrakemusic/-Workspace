...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260516-fr-ledger-db-migration | Migrate FR ledgers + registry from repo files to dedicated encrypted SQLite DB | chore | ⊕Workspace; all 5 projects agent files | BRANCHED | chore/workspace/fr-20260516-fr-ledger-db-migration | pending | ⊕workspace-intake | 2026-05-16 | 2026-05-16 |
