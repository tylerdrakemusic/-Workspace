...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260503-mic-config-template | 1-page printable mic configuration tracking template (Hyperthreat Studios) | feature | ❤Music, ⊕Workspace | BRANCHED (pending) | feature/❤music/mic-config-template, feature/⊕workspace/studio-portal-panel | pending | ⊕workspace-ci | 2026-05-03 | 2026-05-03 |
