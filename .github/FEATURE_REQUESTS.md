...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260427-print-setlist-button | Add Print Button to Setlist in Band Management Panel | feature | ❤Music | TRIAGED | pending | pending | ⊕workspace-intake | 2026-04-27 | 2026-04-27 |
