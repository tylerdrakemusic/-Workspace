...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260425-guitar-trainer-panel-startup | Guitar Trainer Panel: Server Auto-Start + Remove Live-Dash Chrome | fix | ❤Music, ⊕Workspace | REVIEW_REQUESTED | fix/workspace/guitar-trainer-panel-startup | https://github.com/tylerdrakemusic/-Workspace/pull/29 | ⊕workspace-ci | 2026-04-25 | 2026-04-25 |
