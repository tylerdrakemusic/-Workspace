...
|-------|-------|------|----------|-------|--------|-----|-------|--------|---------|
| FR-20260427-fr-flow-auto-ledger-hygiene | Remedy FR Flow: Auto-Commit Ledger Updates Post-Merge + Hygiene Cleanup After Feature Proven | chore | ⊕Workspace | TRIAGED | pending | pending | ⊕workspace-intake | 2026-04-27 | 2026-04-27 |
